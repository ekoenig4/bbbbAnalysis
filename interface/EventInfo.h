...
struct EventInfo{
    ...
    boost::optional<int>     gen_H1_b1_matchedjet;
    boost::optional<int>     gen_H1_b2_matchedjet;
    boost::optional<int>     gen_H2_b1_matchedjet;
    boost::optional<int>     gen_H2_b2_matchedjet;
